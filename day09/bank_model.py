...
mekelle_region = Branch("Mekelle Region")


bole_branch = Branch("Bole Branch")

ayder_branch = Branch("Ayder Branch")
...
mekelle_region.add_child(ayder_branch)
...
print("Accounts reachable from 101:")

print(bfs(transfers, 101))